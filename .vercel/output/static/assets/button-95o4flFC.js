...
import { c as r, s as i } from "./comuns-DP84_GW8.js";
var a = e(n(), 1),
...
function p(e) {
  let t = a.forwardRef((t, n) => {
    ...
    let f = v(i, o.props ?? {});
    return (o.type !== a.Fragment && (f.ref = n ? d : l), a.cloneElement(o, f));
  });
...
var w = f(
  ...
  M = a.forwardRef(({ className: e, variant: t, size: n, asChild: r = !1, ...a }, o) =>
    (0, A.jsx)(r ? m : `button`, {
      className: i(j({ variant: t, size: n, className: e })),
      ref: o,
      ...a,
    }),
  );
